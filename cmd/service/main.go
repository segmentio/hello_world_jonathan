...
import (
	...
	"github.com/segmentio/hello_world_jonathan/internal/hellow"
...
func main() {
	...
	events.Log("starting service", events.Args{
		...
		{Name: "config.datadogAddress", Value: config.DatadogAddress},
	...
	stats.DefaultEngine = stats.NewEngine("hello_world_jonathan", dd)
	defer dd.Close()
	defer stats.Flush()
